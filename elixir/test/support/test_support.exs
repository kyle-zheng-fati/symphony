defmodule SymphonyElixir.TestSupport do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      alias SymphonyElixir.IssueRoute
  ...
  defp workflow_content(overrides) do
    ...
    max_issue_description_chars = Keyword.get(config, :max_issue_description_chars)
    ...
    sections =
      [
        ...
        "  max_issue_description_chars: #{yaml_value(max_issue_description_chars)}",
